...
El objetivo de la presente información es proporcionar a los usuarios de nuestro sitio web [https://marisrigging.it](https://marisrigging.it) información clara y transparente sobre el tratamiento de sus datos personales recogidos durante la navegación en el sitio o el uso de nuestros servicios online.

## 2. Tipos de Datos Recogidos
Entre los datos personales que podrían recogerse automáticamente o ser facilitados voluntariamente por los usuarios pueden incluirse:
- Nombre y apellidos
...
- Responder a solicitudes de contacto a través de formularios o correo electrónico
- Proporcionar información sobre los productos/servicios ofrecidos
- Mejorar la experiencia de navegación y optimizar el funcionamiento del sitio web
- Cumplir con obligaciones legales, contables o fiscales

El tratamiento de los datos se basa en:
- Consentimiento del usuario (por ejemplo, para el envío de newsletters)
- Ejecución de medidas precontractuales o contractuales
- Obligaciones legales
- Interés legítimo del Responsable (por ejemplo, para la seguridad del sitio o el análisis estadístico anónimo)
...
Los datos personales se conservarán durante el tiempo necesario para alcanzar las finalidades indicadas, salvo las obligaciones legales de conservación obligatoria.

## 8. Modificaciones a la Política de Privacidad
La presente Política de Privacidad puede actualizarse periódicamente para adaptarse a cambios normativos o al funcionamiento del sitio. Cualquier modificación se publicará en esta página con la fecha de actualización indicada al inicio del documento.

## 9. Contacto
Para más información o aclaraciones sobre la presente Política de Privacidad, puede contactarnos:
